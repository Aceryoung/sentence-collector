...
const MILESTONES: Milestone[] = [
  { days: 3, emoji: "🌱", title: "새싹 필사인", message: "3일 연속 필사! 좋은 습관이 시작되고 있어요." },
  { days: 7, emoji: "🔥", title: "일주일 완주", message: "7일 연속 필사! 꾸준함이 빛나고 있어요." },
  { days: 14, emoji: "⭐", title: "2주 달성", message: "14일 연속 필사! 이미 습관이 되어가고 있어요." },
  { days: 30, emoji: "🏅", title: "한 달 마스터", message: "30일 연속 필사! 대단한 끈기예요." },
  { days: 50, emoji: "💎", title: "50일 달성", message: "50일 연속 필사! 진정한 필사인이에요." },
  { days: 100, emoji: "🏆", title: "백일 전설", message: "100일 연속 필사! 전설적인 기록이에요." },
];
